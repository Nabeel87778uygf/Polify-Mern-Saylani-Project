...
import { otpStepStyles as s, uiElementStyles as ui } from "../assets/dummyStlyes";
...
export default function OtpStep({
    ...
    const [left, setLeft] = useState(60); //60 seconds timer
            ...
            <div className="space-y-1.5">
                ...
                <div className={s.otpDotsContainer}>
                    {Array.from({ length: 6 }).map((_, i) => (
                        <div
                            key={i}
                            className={`${s.otpDot} ${i < otp.length ? s.otpDotFilled : s.otpDotEmpty
                                }`}
                        />
                    ))}
                </div>
