...
function ResultBar({ label, percent, highlight, winner, onClick }) {
    ...
    return (
        <div
            onClick={onClick}
            className={`${s.resultBarBase} ${highlight ? s.resultBarHighlight : s.resultBarDefault
                }`}
            title={highlight ? "Click to remove your vote" : ""}
        >
            <div
                className={`${s.resultBarFill} ${highlight
            ...
            <div className={s.resultBarContent}>
                <span
                    className={`${s.resultBarLabelBase} ${highlight ? s.resultBarLabelHighlight : s.resultBarLabelDefault
                        }`}
                >
                    {highlight && (
                ...
                <span
                    className={`${s.resultBarPercentBase} ${highlight ? s.resultBarPercentHighlight : s.resultBarPercentDefault
                        }`}
                >
                    {highlight && (
    ...
    return (
        <div>
            <div className={s.versusBarContainer}>
                <div
                    className={`${s.versusYesBase} ${hasVote && myVote === 0 ? s.versusYesHover : ""
                        }`}
                    style={{ width: `${w}%` }}
                ...
                <div
                    className={`${s.versusNoBase} ${hasVote && myVote === 1 ? s.versusNoHover : ""
                        }`}
            ...
            <div className={s.versusLabels}>
                <span
                    onClick={() => hasVote && myVote === 0 && onUnvote && onUnvote()}
                    className={`${s.versusLabelYesBase} ${myVote === 0 ? s.versusLabelYesActive : s.versusLabelYesInactive
                        }`}
                    title={myVote === 0 ? "Click to remove your vote" : ""}
                >
                ...
                <span
                    onClick={() => hasVote && myVote === 1 && onUnvote && onUnvote()}
                    className={`${s.versusLabelNoBase} ${myVote === 1 ? s.versusLabelNoActive : s.versusLabelNoInactive
                        }`}
                    title={myVote === 1 ? "Click to remove your vote" : ""}
                >
                    {myVote === 1 && (
                ...
                {poll.results.map((r, i) => (
                    <div key={i} className="space-y-1.5">
                        <div
                            ...
                            className={`${s.imageItemBase} ${poll.myVote === i ? s.imageItemActive : s.imageItemInactive
                                }`}
