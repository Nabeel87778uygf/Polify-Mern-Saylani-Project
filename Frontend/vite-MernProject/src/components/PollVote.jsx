        ...
        return (
            <div className={s.yesNoGrid}>
                <button
                    ...
                    className={`${s.yesNoButtonBase} ${isMyVote(0) ? s.yesNoButtonYesActive : s.yesNoButtonYesInactive
                        }`}
                ...
                <button
                    ...
                    className={`${s.yesNoButtonBase} ${isMyVote(1) ? s.yesNoButtonNoActive : s.yesNoButtonNoInactive
                        }`}
            ...
            <div className={s.singleContainer}>
                {poll.options.map((o, i) => (
                    <button
                        ...
                        className={`${s.singleOptionBase} ${isMyVote(i) ? s.singleOptionActive : s.singleOptionInactive
                            }`}
                        title={isMyVote(i) ? "Click to remove your vote" : ""}
                    >
                        <span
                            className={`${s.singleOptionCircleBase} ${isMyVote(i)
                ...
                <div className={s.imageGrid}>
                    {poll.options.map((o, i) => (
                        <button
                            ...
                            className={`${s.imageItemBase} ${isMyVote(i)
                                ? s.imageItemActive
                                : sel === i
                                    ? s.imageItemSelected
                                    : s.imageItemInactive
